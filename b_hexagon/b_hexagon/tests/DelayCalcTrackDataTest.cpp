...
protected:
    ...
    DelayCalcTrackData validData;
};

TEST_F(DelayCalcTrackDataTest, DefaultConstructor_InitializesAllFieldsToZero) {
    // Act
    DelayCalcTrackData defaultData;
...
TEST_F(DelayCalcTrackDataTest, IsValid_ZeroTrackId_ReturnsFalse) {
    // Arrange
    validData.trackId = 0;
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativeTrackId_ReturnsFalse) {
    // Arrange
    validData.trackId = -1;
...
TEST_F(DelayCalcTrackDataTest, IsValid_InfiniteVelocityX_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NaNVelocityY_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_InfinitePositionZ_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NaNPositionX_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativeUpdateTime_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativeFirstHopDelayTime_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativeSecondHopSentTime_ReturnsFalse) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_ExcessiveVelocityMagnitude_ReturnsFalse) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_SecondHopBeforeFirstHop_ReturnsFalse) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_ZeroDelayTimesButValidOtherTimes_ReturnsTrue) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_ValidTimingSequence_ReturnsTrue) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_ZeroVelocities_ReturnsTrue) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativePositions_ReturnsTrue) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_NegativeVelocities_ReturnsTrue) {
...
TEST_F(DelayCalcTrackDataTest, IsValid_ZeroTimestamps_ReturnsTrue) {
    // Arrange
...
TEST_F(DelayCalcTrackDataTest, IsValid_LargeValidVelocities_ReturnsTrue) {
