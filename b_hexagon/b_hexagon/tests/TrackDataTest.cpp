...
TEST_F(TrackDataTest, DefaultConstructor_InitializesAllFieldsToZero) {
    // Act
    TrackData defaultData;
...
TEST_F(TrackDataTest, IsValid_ZeroTrackId_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NegativeTrackId_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_InfiniteVelocityX_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_InfiniteVelocityY_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_InfiniteVelocityZ_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NaNVelocityX_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_InfinitePositionX_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NaNPositionY_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NegativeUpdateTime_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NegativeOriginalUpdateTime_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NegativeFirstHopSentTime_ReturnsFalse) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_ExcessiveVelocityMagnitude_ReturnsFalse) {
...
TEST_F(TrackDataTest, IsValid_ZeroVelocities_ReturnsTrue) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_ZeroPositions_ReturnsTrue) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_ZeroTimestamps_ReturnsTrue) {
    // Arrange
...
TEST_F(TrackDataTest, IsValid_NegativePositions_ReturnsTrue) {
...
TEST_F(TrackDataTest, IsValid_NegativeVelocities_ReturnsTrue) {
